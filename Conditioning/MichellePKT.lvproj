...
<Project Type="Project" LVVersion="19008000">
	<Property Name="varPersistentID:{0C2E1CCF-E908-4A3B-A993-5D0F9A08A0CB}" Type="Ref">/My Computer/michelle_library.lvlib/InitiatedLag</Property>
	<Property Name="varPersistentID:{17653292-77C3-4387-98D6-3C979655D13B}" Type="Ref">/My Computer/michelle_library.lvlib/Velocity</Property>
	<Property Name="varPersistentID:{296C00CC-8DEC-4BE3-BFF8-2E92F7EE9A76}" Type="Ref">/My Computer/michelle_library.lvlib/Active_trial</Property>
	<Property Name="varPersistentID:{32D7F7E1-F24E-42B6-8479-861EB5D503DA}" Type="Ref">/My Computer/michelle_library.lvlib/GlobalStartTime</Property>
	<Property Name="varPersistentID:{34914501-3144-4CCE-A959-363DB2077BE0}" Type="Ref">/My Computer/michelle_library.lvlib/GlobalTime</Property>
	<Property Name="varPersistentID:{3DEBF7A2-7377-4366-9DD1-F8CB26AEA317}" Type="Ref">/My Computer/michelle_library.lvlib/TSLog_Behavior</Property>
	<Property Name="varPersistentID:{4361E20F-A322-4557-AA4A-BB9486F94E82}" Type="Ref">/My Computer/michelle_library.lvlib/ISI</Property>
	<Property Name="varPersistentID:{49E60F7F-FFCD-40C4-90CD-F810BD6B03F6}" Type="Ref">/My Computer/michelle_library.lvlib/InitiatedStamp</Property>
	<Property Name="varPersistentID:{5C302E5A-555A-4694-AA56-64E0F3C3CAC7}" Type="Ref">/My Computer/michelle_library.lvlib/InitiatedTime</Property>
	<Property Name="varPersistentID:{61FB4239-DC2D-4FFA-A9F8-CB315C28108D}" Type="Ref">/My Computer/michelle_library.lvlib/Display</Property>
	<Property Name="varPersistentID:{7476FA3C-C32B-4D7B-98BB-8368387D3C0D}" Type="Ref">/My Computer/michelle_library.lvlib/Timings</Property>
	<Property Name="varPersistentID:{7C47CF58-0B38-4F8E-B187-B0DF4BCB6312}" Type="Ref">/My Computer/michelle_library.lvlib/Time_since_lick</Property>
	<Property Name="varPersistentID:{84949512-6E41-4726-9592-441FD567B981}" Type="Ref">/My Computer/michelle_library.lvlib/Array temp2</Property>
	<Property Name="varPersistentID:{875F0A09-7BDA-444A-BFAE-77013CFC3D89}" Type="Ref">/My Computer/michelle_library.lvlib/Output</Property>
	<Property Name="varPersistentID:{89BFF357-4B24-4C6C-A04D-A2B6928C9B58}" Type="Ref">/My Computer/michelle_library.lvlib/ContrastChoice</Property>
	<Property Name="varPersistentID:{9620853C-28AE-48E8-A9EF-80A17A31085E}" Type="Ref">/My Computer/michelle_library.lvlib/Reward_mat</Property>
	<Property Name="varPersistentID:{974EC4AC-9883-4A9C-ABA8-FB41E1D75C10}" Type="Ref">/My Computer/michelle_library.lvlib/TimeInitiated</Property>
	<Property Name="varPersistentID:{9D3A47CE-4AA6-42F7-8913-2F25995E3A7D}" Type="Ref">/My Computer/michelle_library.lvlib/Stim_ID</Property>
	<Property Name="varPersistentID:{AACB1D66-9D90-4612-8459-D2FDF4B62755}" Type="Ref">/My Computer/michelle_library.lvlib/EnticeLimiter</Property>
	<Property Name="varPersistentID:{C2A5FA43-F2A2-4672-83C2-63CAF7125E8F}" Type="Ref">/My Computer/michelle_library.lvlib/ConsumptionON</Property>
	<Property Name="varPersistentID:{C8D413E2-30D4-45F9-B1FC-FAA11E1DED71}" Type="Ref">/My Computer/michelle_library.lvlib/Timeout</Property>
	<Property Name="varPersistentID:{CB92D641-718E-48F3-A15E-F108CBDBF388}" Type="Ref">/My Computer/michelle_library.lvlib/ISI_Time</Property>
	<Property Name="varPersistentID:{D58C8840-E733-421D-A194-A44161E3793E}" Type="Ref">/My Computer/michelle_library.lvlib/Num_trials</Property>
	<Property Name="varPersistentID:{DB290D8B-7982-4148-9D1D-F12ADF427C9E}" Type="Ref">/My Computer/michelle_library.lvlib/Frame_clock</Property>
	<Property Name="varPersistentID:{DC0BAE93-6113-474E-B704-DB5F4A705E1B}" Type="Ref">/My Computer/michelle_library.lvlib/Stop</Property>
	<Property Name="varPersistentID:{E5051CB9-8F11-4D0A-93CE-02BFC3FA6329}" Type="Ref">/My Computer/michelle_library.lvlib/GlobalReward</Property>
	<Property Name="varPersistentID:{E9D7B519-06A2-47E4-A903-DC67D28AAFD7}" Type="Ref">/My Computer/michelle_library.lvlib/Trial</Property>
	<Property Name="varPersistentID:{FEE0AE0B-7B67-4D8E-A09C-883D47D846A4}" Type="Ref">/My Computer/michelle_library.lvlib/VidFrameClock1</Property>
	<Property Name="varPersistentID:{FF0CE614-4D37-497F-86BD-20571E4A5E3F}" Type="Ref">/My Computer/michelle_library.lvlib/Stim_loaded</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="display_michelle_PKT_visjitter_stopadded_RandCont.vi" Type="VI" URL="../display_michelle_PKT_visjitter_stopadded_RandCont.vi"/>
		<Item Name="display_michelle_PKT_visjitter_stopadded_RandCont_Psuedo.vi" Type="VI" URL="../display_michelle_PKT_visjitter_stopadded_RandCont_Psuedo.vi"/>
		<Item Name="display_michelle_PKT_visjitter_stopadded_RandCont_Psuedo_FrameClock.vi" Type="VI" URL="../display_michelle_PKT_visjitter_stopadded_RandCont_Psuedo_FrameClock.vi"/>
		<Item Name="display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO.vi" Type="VI" URL="../display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO.vi"/>
		<Item Name="display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_FrameClock2.vi" Type="VI" URL="../display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_FrameClock2.vi"/>
		<Item Name="display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_TSLogFC1.vi" Type="VI" URL="../display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_TSLogFC1.vi"/>
		<Item Name="display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_TSLogFC2.vi" Type="VI" URL="../display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_TSLogFC2.vi"/>
		<Item Name="display_michelle_PTK_visjitter_stopadded_RandCont_PsuedoCO_TSLog.vi" Type="VI" URL="../display_michelle_PTK_visjitter_stopadded_RandCont_PsuedoCO_TSLog.vi"/>
		<Item Name="display_michelle_PTK_visjitter_stopadded_RandCont_PsuedoCO_TSLogV2.vi" Type="VI" URL="../display_michelle_PTK_visjitter_stopadded_RandCont_PsuedoCO_TSLogV2.vi"/>
		<Item Name="display_michelle_visjitter_stopadded_ContrastTitration.vi" Type="VI" URL="../display_michelle_visjitter_stopadded_ContrastTitration.vi"/>
		<Item Name="display_michelle_visjitter_stopadded_RandCont_PsuedoCO_TSLog.vi" Type="VI" URL="../display_michelle_visjitter_stopadded_RandCont_PsuedoCO_TSLog.vi"/>
		<Item Name="GlobalVars.vi" Type="VI" URL="../GlobalVars.vi"/>
		<Item Name="michelle_library.lvlib" Type="Library" URL="../michelle_library.lvlib"/>
		<Item Name="retinotopic_map_display_only_120520.vi" Type="VI" URL="../../Stimulus_scripts/retinotopic_map_display_only_120520.vi"/>
		<Item Name="retinotopic_map_display_only_120520_svadded.vi" Type="VI" URL="../../Stimulus_scripts/retinotopic_map_display_only_120520_svadded.vi"/>
		<Item Name="display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_TSLogFC2_ForTraining.vi" Type="VI" URL="../display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_TSLogFC2_ForTraining.vi"/>
		<Item Name="retinotopic_map_display_only_120520_svadded_fr.vi" Type="VI" URL="../../Stimulus_scripts/retinotopic_map_display_only_120520_svadded_fr.vi"/>
		<Item Name="display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_TSLogFC2_forrecording.vi" Type="VI" URL="../display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_TSLogFC2_forrecording.vi"/>
		<Item Name="display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_TSLogFC2_lightdetection.vi" Type="VI" URL="../display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_TSLogFC2_lightdetection.vi"/>
		<Item Name="display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_TSLogFC2_ForTrainingLT.vi" Type="VI" URL="../display_michelle_PKT_visjitter_stopadded_RandCont_PsuedoCO_TSLogFC2_ForTrainingLT.vi"/>
	...
	<Item Name="NI-myRIO-1900-03050bd9" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">NI-myRIO-1900-03050bd9</Property>
...
DirectoryIndex index.htm
		...
		<Item Name="lick_shaping.vi" Type="VI" URL="../lick_shaping.vi"/>
		<Item Name="lick_shaping_5s.vi" Type="VI" URL="../lick_shaping_5s.vi"/>
		<Item Name="LickSpout_VolumeTest.vi" Type="VI" URL="../LickSpout_VolumeTest.vi"/>
		<Item Name="LickSpoutPrimer.vi" Type="VI" URL="../LickSpoutPrimer.vi"/>
		<Item Name="reward_behavior_michelle_visjitter.vi" Type="VI" URL="../reward_behavior_michelle_visjitter.vi"/>
		<Item Name="reward_behavior_michelle_visjitter_conswin.vi" Type="VI" URL="../reward_behavior_michelle_visjitter_conswin.vi"/>
		<Item Name="reward_behavior_michelle_visjitter_conswin_AllEnticefx.vi" Type="VI" URL="../reward_behavior_michelle_visjitter_conswin_AllEnticefx.vi"/>
		<Item Name="reward_behavior_michelle_visjitter_conswin_entice.vi" Type="VI" URL="../reward_behavior_michelle_visjitter_conswin_entice.vi"/>
		<Item Name="reward_behavior_michelle_visjitter_conswin_enticefx.vi" Type="VI" URL="../reward_behavior_michelle_visjitter_conswin_enticefx.vi"/>
		<Item Name="reward_behavior_michelle_visjitter_conswinAdapt_enticefx.vi" Type="VI" URL="../reward_behavior_michelle_visjitter_conswinAdapt_enticefx.vi"/>
		<Item Name="reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog.vi" Type="VI" URL="../reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog.vi"/>
		<Item Name="reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLogV2.vi" Type="VI" URL="../reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLogV2.vi"/>
		<Item Name="reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog_VF.vi" Type="VI" URL="../reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog_VF.vi"/>
		<Item Name="CameraTesting.vi" Type="VI" URL="../CameraTesting.vi"/>
		<Item Name="CameraTesting2.vi" Type="VI" URL="../CameraTesting2.vi"/>
		<Item Name="CameraTesting3.vi" Type="VI" URL="../CameraTesting3.vi"/>
		<Item Name="CameraTesting4.vi" Type="VI" URL="../CameraTesting4.vi"/>
		<Item Name="CameraTesting5.vi" Type="VI" URL="../CameraTesting5.vi"/>
		<Item Name="behavior_only.vi" Type="VI" URL="../behavior_only.vi"/>
		<Item Name="reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog_VF_withvid.vi" Type="VI" URL="../reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog_VF_withvid.vi"/>
		<Item Name="reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog_VF_fortraining.vi" Type="VI" URL="../reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog_VF_fortraining.vi"/>
		<Item Name="reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog_VF_forrecording.vi" Type="VI" URL="../reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog_VF_forrecording.vi"/>
		<Item Name="reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog_VF_fortraining_lightdetection.vi" Type="VI" URL="../reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog_VF_fortraining_lightdetection.vi"/>
		<Item Name="reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog_VF_fortraining_lightdetectionV2.vi" Type="VI" URL="../reward_behavior_michelle_visjitter_conswinAdapt_enticefx_TSLog_VF_fortraining_lightdetectionV2.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
